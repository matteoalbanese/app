...
function Worker() {
	...
	return (
		<div className="App">
			...
			<MyGroup fcn={contractExecute} buttonLabel={"Worker"} text={executeTextSt} link={executeLinkSt} />


			<div className="logo">
				<div className="symbol">
					<img src="hedera-example-metamask-counter-dapp-master\src\assets\android-chrome-512x512.png"></img>
				</div>
				<span>Hedera</span>
			</div>
		</div>
