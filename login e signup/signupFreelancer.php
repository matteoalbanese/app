<?php
    ...
    if(!empty($_POST['firstname']) && !empty($_POST['lastname']) && !empty($_POST['username']) && !empty($_POST['email']) && !empty($_POST['password']) && !empty($_POST['confirm_password']) && !empty($_POST['allow']))
    {
        $error = array();
...
<body>
    ...
    <section>
     ...
     <div id="registrati">
        ...
        <a href="signupClient.php">Join as a client</a>
     </div>
